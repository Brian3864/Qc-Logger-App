...
const defaultGRows = Array.from({ length: 10 }, () => ({
  reference: "",
  actual: "",
}));

const [gRows, setGRows] = React.useState(defaultGRows);

const updateGReference = (index, value) => {
  setGRows((rows) =>
    rows.map((r, i) =>
...
const updateGActual = (index, value) => {
  setGRows((rows) =>
    rows.map((r, i) =>
